...
import { submitSell } from "./../helpers/payment";
...
const Sell = () => {
  ...
  const handleSubmitPayment = async (form) => {
    ...
    const [err, response] = await submitSell(
    ...
    enqueueSnackbar("Success! Your balance should update momentarily", {
      variant: "success",
      anchorOrigin: {
        vertical: "top",
        horizontal: "center",
    ...
    <div className={classNames(styles["buy"], "p-0")}>
      ...
      >
        <Box
          ...
          pr={1}
        >
          <DialogTitle>Select an asset to sell</DialogTitle>
